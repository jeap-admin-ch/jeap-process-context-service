...
public interface MessageSearchQueryRepository {
     ...
     */
    Set<MessageData> getMessageDataForMessageType(UUID processInstanceId, String messageType);
     ...
     */
    long countMessagesByTypeWithMessageData(UUID processInstanceId, String messageType, String messageDataKey, String messageDataValue);
     ...
     */
    boolean containsMessageByTypeWithMessageData(UUID processInstanceId, String messageType, String messageDataKey, String messageDataValue);
     ...
     * @return true if at least one matching message exists, false otherwise
     */
    boolean containsMessageByTypeWithAnyMessageDataValue(UUID processInstanceId, String messageType, String messageDataKey, Set<String> messageDataValues);
