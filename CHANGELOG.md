...
- Update Angular to 21.2.19 and fast-uri to 4.1.2 to fix security vulnerabilities.
...
- Override systeminformation version to 5.31.7 due to CVE-2026-50289
...
- Update parent from 33.9.0 to 33.11.0
...
- Override Lodash version to 4.18.1 (instead 4.17.23) to fix vulnerability
