...
CREATE INDEX CONCURRENTLY IF NOT EXISTS event_reference_process_instance_events_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS events_event_data_events_id_template_name
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS events_id_event_name
