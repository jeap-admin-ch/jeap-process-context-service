 ...
 * jeap-process-context-adapter-kafka - [ch.admin.bit.jeap:jeap-process-context-adapter-kafka](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-adapter-kafka)
 * jeap-process-context-adapter-micrometer - [ch.admin.bit.jeap:jeap-process-context-adapter-micrometer](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-adapter-micrometer)
 * jeap-process-context-adapter-objectstorage - [ch.admin.bit.jeap:jeap-process-context-adapter-objectstorage](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-adapter-objectstorage)
 * jeap-process-context-adapter-rest-api - [ch.admin.bit.jeap:jeap-process-context-adapter-rest-api](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-adapter-rest-api)
 * jeap-process-context-domain - [ch.admin.bit.jeap:jeap-process-context-domain](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-domain)
 * jeap-process-context-domain-test - [ch.admin.bit.jeap:jeap-process-context-domain-test](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-domain-test)
 * jeap-process-context-message - [ch.admin.bit.jeap:jeap-process-context-message](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-message)
 * jeap-process-context-plugin-api - [ch.admin.bit.jeap:jeap-process-context-plugin-api](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-plugin-api)
 * jeap-process-context-repository-jpa - [ch.admin.bit.jeap:jeap-process-context-repository-jpa](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-repository-jpa)
 * jeap-process-context-repository-template-json - [ch.admin.bit.jeap:jeap-process-context-repository-template-json](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-repository-template-json)
 * jeap-process-context-scs - [ch.admin.bit.jeap:jeap-process-context-scs](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-scs)
 * jeap-process-context-ui - [ch.admin.bit.jeap:jeap-process-context-ui](https://github.com/jeap-admin-ch/jeap-process-context-service/tree/main/jeap-process-context-ui)
 ...
 * shedlock-core - [net.javacrumbs.shedlock:shedlock-core](http://nexus.sonatype.org/oss-repository-hosting.html/shedlock-parent/shedlock-core)
 * shedlock-provider-jdbc-template - [net.javacrumbs.shedlock:shedlock-provider-jdbc-template](http://nexus.sonatype.org/oss-repository-hosting.html/shedlock-parent/providers/jdbc/shedlock-provider-jdbc-template)
 * shedlock-spring - [net.javacrumbs.shedlock:shedlock-spring](http://nexus.sonatype.org/oss-repository-hosting.html/shedlock-parent/spring/shedlock-spring)
